...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-5xl mx-auto space-y-5">
            <!-- Warning banner -->
            <div
                class="flex items-start gap-3 bg-amber-50 border border-amber-200 text-amber-800 px-5 py-3.5 rounded-xl text-sm"
            >
                <fa-icon
                ...
                />
                <p>
                    Assets in trash are hidden from the inventory but their
                    history (assignments, logs) is preserved. Permanent deletion
                    cannot be undone.
                </p>
            </div>
                            ...
                            >
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-9 h-9 rounded-lg bg-gray-100 flex items-center justify-center text-rose-400 shrink-0"
                                        >
                                            <CategoryIcon
        ...
        <Modal :show="showForceModal" @close="showForceModal = false">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-700 mb-2">
                    ...
                    >. The asset and all its related logs will be permanently
