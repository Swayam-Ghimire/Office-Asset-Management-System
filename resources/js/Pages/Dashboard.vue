            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">
                        {{
                            $page.props.isAdmin
                                ? "Manage assets, requests and users"
                                : "Track your assets and requests"
                        }}
                    </p>
                </div>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <template v-if="$page.props.isAdmin">
                    ...
                    >
                        <div
                            class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 col-span-1"
                        >
                            <p
                            ...
                            <div class="mt-3 h-1 bg-gray-100 rounded-full">
                                <div
                                    class="h-1 bg-gray-400 rounded-full w-full"
                                ></div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div class="mt-3 h-1 bg-amber-100 rounded-full">
                                <div
                                    ...
                                    :style="`width:${stats.total_assets ? Math.round((stats.maintenance / stats.total_assets) * 100) : 0}%`"
                                ></div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div class="mt-3 h-1 bg-rose-100 rounded-full">
                                <div
                                    class="h-1 bg-rose-500 rounded-full w-full"
                                ></div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div class="mt-3 h-1 bg-violet-100 rounded-full">
                                <div
                                    class="h-1 bg-violet-500 rounded-full w-full"
                                ></div>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            >
                                <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="ml-1 bg-rose-100 text-rose-700 text-xs px-2 py-0.5 rounded-full font-medium"
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-sm font-bold text-gray-500 shrink-0"
                                    >
                                        {{
                                            req.user?.name
                                                ?.charAt(0)
                        ...
                        >
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="text-gray-600 font-medium truncate"
                                            >{{ item.name }}</span
                                        >
                                        <span
                        ...
                        >
                            <table class="w-full text-sm">
                                <thead>
                                    ...
                                    >
                                        <th
                                            class="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide"
                                        >
                                            Asset
                                        </th>
                                        <th
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-6 py-3 text-gray-500 text-xs"
                                        >
                                            {{
                                                new Date(
                                                    a.assigned_date,
