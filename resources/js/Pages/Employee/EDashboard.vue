            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">
                        Track your assigned assets and requests
                    </p>
                </div>
                <Link
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                    <!-- My Assets (3 cols) -->
                    <div
                        class="lg:col-span-3 bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    >
                                        {{
                                            a.asset?.model_name ?? a.asset?.name
                                        }}
                                    </p>
                                    <p class="text-xs text-gray-400 mt-0.5">
                                        ...
                                        >
                                        <span class="mx-1.5 text-gray-300"
                                            >·</span
                                        >
                                        Since
                                        {{
                        ...
                        <div v-else class="px-6 py-16 text-center">
                            ...
                            <p class="text-xs text-gray-400 mb-4">
                                Browse the inventory and make a request
                            </p>
                            <Link
                                :href="route('home')"
