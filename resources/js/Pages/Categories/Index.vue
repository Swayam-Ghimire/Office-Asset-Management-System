...
function submitEdit(cat) {
    editForm.patch(route('categories.update', cat.id), {
...
function submitDelete() {
    router.delete(route('categories.destroy', deletingCategory.value.id), {
        onSuccess: () => { showDeleteModal.value = false; deletingCategory.value = null; },
    });
}
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Manage asset types used across the inventory</p>
            </div>
        </template>
        ...
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-400">{{ categories.total }} total</span>
                </div>

                <div v-if="categories.data.length > 0" class="divide-y divide-gray-50">
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div v-else>
                                ...
                                <p class="text-xs text-gray-400 mt-0.5">
                                    {{ cat.assets_count }} asset{{ cat.assets_count !== 1 ? 's' : '' }}
                                </p>
                            </div>
                        </div>

                        <!-- Actions -->
                        <div v-if="editingId !== cat.id" class="flex gap-1 shrink-0">
                            <button
                                @click="startEdit(cat)"
                            ...
                            <button
                                ...
                                :title="cat.assets_count > 0 ? 'Has assets — cannot delete' : 'Delete'"
                ...
                <div v-else class="px-6 py-12 text-center">
                    <fa-icon icon="tags" class="w-10 h-10 text-gray-200 mb-3" />
            ...
            <div class="p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ deletingCategory?.name }}</p>
                    </div>
                </div>
                <p class="text-sm text-gray-700 mb-6">
                    This will permanently delete this category. Assets in this category will become uncategorized.
                </p>
