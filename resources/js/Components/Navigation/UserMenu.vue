...
const avatarUrl = (name) =>
    `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&color=ffffff&background=DC143C`;
...
<template>
    <div id="user-menu" class="relative">
        ...
        >
            <img
                :src="user.img_path ? '/storage/' + user.img_path : avatarUrl(user.name)"
                :alt="user.name"
            ...
            <fa-icon icon="chevron-down" class="w-3 h-3 text-gray-400 hidden md:block" />
        </button>
            ...
            >
                ...
                <div class="py-1">
                    <Link
                        ...
                        @click="open = false"
                    >
                        <fa-icon icon="user-pen" class="w-4 h-4 text-gray-400" />
                        Edit profile
                    </Link>
                </div>
                ...
                <div class="border-t border-gray-100 py-1">
                    <Link
                        ...
                        @click="open = false"
                    >
                        <fa-icon icon="arrow-right-from-bracket" class="w-4 h-4" />
                        Log out
                    </Link>
                </div>
            </div>
